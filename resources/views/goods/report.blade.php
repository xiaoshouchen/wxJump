...
<div class="page_bd">
    ...
    <div id="step1" class="category_item"><h3 class="category_title">请选择举报原因</h3>
        ...
        <div class="opr_area"><a id="nextBtn" href="http://www.ffdvta.cn/jubao2.html"
    ...
    <div id="step2" class="category_item" style="display:none;"><h3 class="category_title">举报描述</h3>
        <form>
            <div id="textareaDiv" class="textarea_panel"><textarea id="reasonText"></textarea><i id="reasonTextTips"
...
<script id="result_tmpl" type="text/html">
    <div class="page_msg">
        ...
        <div class="opr_area"><a id="successBtn_1" class="btn btn_primary" href="javascript:;">确定</a></div>
    </div>
